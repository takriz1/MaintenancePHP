        ...
        <?php if(isset($_GET['error'])) { ?>
                <p style="color:red;">ERROR! USERNAME OR PASSWORD IS INCORRECT</p>
                        <?php } else { ?>
                            <p> Admin </p>
                             <?php }?> 
             <p class="para">Email </p><input type="text" placeholder="Email" name="email"><br>
             <p class="para">Mot de passe </p> <input type="password" placeholder="Mot de passe" name="password"><br>
